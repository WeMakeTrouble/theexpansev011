/**
 * ============================================================================
 * Admin Razor Sub-Router — Ockham's Razor Diagnostic API
 * ============================================================================
 *
 * WHAT THIS MODULE IS:
 * ---------------------------------------------------------------------------
 * Express sub-router handling all /api/admin/razor/* endpoints.
...
const logger = createModuleLogger('AdminRazor');
const router = Router();
